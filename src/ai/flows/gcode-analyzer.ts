// src/ai/flows/gcode-analyzer.ts
'use server';

/**
 * @fileOverview A G-code analyzer AI agent that extracts printing time and filament weight from a G-code file.
 *
 * - analyzeGcode - A function that handles the G-code analysis process.
 * - AnalyzeGcodeInput - The input type for the analyzeGcode function.
 * - AnalyzeGcodeOutput - The return type for the analyzeGcode function.
 */

import {ai} from '@/ai/genkit';
import {z} from 'genkit';

const AnalyzeGcodeInputSchema = z.object({filename: z.string().describe('Name of the uploaded gcode file.'), gcodeDataUri: z.string().describe(
